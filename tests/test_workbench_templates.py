    ...
    def test_template_basic_weibull(self, client: TestClient):
        ...
        payload = {
            "nodes": [
                ...
                {"id": "filter-1", "type": "filter", "data": {"equipment": "Motor A"}, "x": 280, "y": 150},
    ...
    def test_template_kijima_repair(self, client: TestClient):
        ...
        payload = {
            "nodes": [
                ...
                {"id": "filter-2", "type": "filter", "data": {"equipment": "Motor A"}, "x": 280, "y": 150},
                {"id": "kijima-2", "type": "kijima", "data": {"model_types": [1, 2, 3]}, "x": 520, "y": 150}
            ],
            "edges": [
    ...
    def test_template_ram_simulation(self, client: TestClient):
        ...
        payload = {
            "nodes": [
                ...
                {"id": "filter-3", "type": "filter", "data": {"equipment": "Motor A"}, "x": 250, "y": 150},
    ...
    def test_template_pareto_analysis(self, client: TestClient):
        ...
        payload = {
            "nodes": [
                ...
                {"id": "filter-4", "type": "filter", "data": {"equipment": ""}, "x": 250, "y": 150},
                {"id": "pareto-4", "type": "pareto", "data": {"group_by": "Equipment"}, "x": 450, "y": 50},
                {"id": "jackknife-4", "type": "jackknife", "data": {"compare_by": "Equipment"}, "x": 450, "y": 250}
            ],
            "edges": [
        ...
        assert "jackknife-4" in results and results["jackknife-4"]["status"] == "success"
    ...
    def test_template_trend_flow(self, client: TestClient):
        ...
        payload = {
            "nodes": [
                ...
                {"id": "filter-5", "type": "filter", "data": {"equipment": "Motor A"}, "x": 250, "y": 150},
